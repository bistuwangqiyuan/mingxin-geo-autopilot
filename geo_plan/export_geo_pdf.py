...
OUT_PDF = os.path.join(os.path.dirname(BASE), "中科存储-GEO提升计划.pdf")
...
def _meta():
    try:
        ...
        return {"header": "深圳市中科航星科技有限公司 · 中科存储 GEO 提升计划",
                "footer": "深圳市中科航星科技有限公司"}


def export():
    meta = _meta()
    header = meta.get("header", "")
    footer = meta.get("footer", "深圳市中科航星科技有限公司")
